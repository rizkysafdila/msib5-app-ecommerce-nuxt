...
<template>
  <section class="bg-white">
    <div class="container mx-auto lg:gap-8 xl:gap-0 py-12 lg:py-24 px-8">
      <HomeSectionHeader title="Latest Product" button-url="#" />
      <div class="flex flex-wrap md:flex-nowrap justify-center md:justify-start items-center relative">
        ...
        <div class="w-full mt-4 md:mt-0 md:-ml-28 overflow-hidden">
          <Swiper :slides-per-view="1" :space-between="24" :breakpoints="breakpoints"
            :navigation="{ enabled: true, nextEl: '#next-slide' }">
        ...
        <button id="next-slide"
          class="absolute z-10 -end-6 top-2/3 md:top-1/2 text-white bg-black opacity-30 p-2 rounded-full">
          <Icon name="tabler:chevron-right" size="32" />
        </button>
      </div>
    </div>
  </section>
